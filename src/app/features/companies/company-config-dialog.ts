...
export class CompanyConfigDialog {
  ...
  private readonly model = signal<ConfigFormModel>({
    ...
    cameraDefaultPort: this.data.config.cameraDefaultPort,
    cameraDefaultAuthType: this.data.config.cameraDefaultAuthType,
    cameraSnapshotIntervalMs: this.data.config.cameraSnapshotIntervalMs,
    anprConfidenceThreshold: this.data.config.anprConfidenceThreshold,
    anprMatchTimeoutSeconds: this.data.config.anprMatchTimeoutSeconds,
    anprConfirmationReads: this.data.config.anprConfirmationReads,
    anprStaleAfterSeconds: this.data.config.anprStaleAfterSeconds,
    anprAutoRegister: this.data.config.anprAutoRegister,
    anprSaveUnrecognizedPhotos: this.data.config.anprSaveUnrecognizedPhotos,
    anprAutoRegisterCooldownSeconds: this.data.config.anprAutoRegisterCooldownSeconds,
    movementAutoCloseMinutes: this.data.config.movementAutoCloseMinutes,
